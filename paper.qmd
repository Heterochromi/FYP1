...
format:
  mmu-fyp-typst:
    ...
    list-of-definitions: |
      Impulse response: a digital "snapshot" or audio fingerprint that captures how a space responds to sound. \ It is used in audio processing to simulate the acoustics of a room.
---
...
Etiher attach or write your technical documentation here. if needed.
